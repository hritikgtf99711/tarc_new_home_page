            ...
            <div className='grid grid-cols-2 lg:grid-cols-12'>
                <div className='col-span-3'>
                    ...
                    <ul className='mt-[30px] lg:mt-[50px]'>
                        ...
                        <li><a href="" className='text-white text-[16px] flex place-items-start leading-[30px] gap-[20px]'><img width={'20'} src="./assets/icons/icon_location.svg" alt=""/><span> 2nd Floor, C-3, Qutab <span className='lg:block'></span>
                        Institutional Area Road, Block C,<span className='lg:block'></span>
                        Katwaria Sarai, Delhi 110016</span></a></li>
                    </ul>

                </div>
                <div className='col-span-6 m-[auto] text-center my-[30px]  lg:my-[100px]'>
                    <img src='./assets/images/footer_logo.jpg' alt='' width={'180'} className='rounded-[50%] lg:w-[150px] w-[130px] m-[auto]'/>
                ...
                <div className='col-span-3 '>
                    <Heading Heading={'quick links'} className={'!text-white  lg:text-end lg:text-[32px]'}/>
                    <ul className='mt-[30px] lg:mt-[50px] uppercase lg:text-end'>
                            <li className='mb-[16px] text-[16px] lg:mb-[20px] '>
                            ...
                            <li className='mb-[16px] text-[16px] lg:mb-[20px] '><a href="" className='text-white  gap-[20px]'> Press Releases</a></li>
                            <li className='mb-[16px] text-[16px] lg:mb-[20px] '><a href="" className='text-white  gap-[20px]'>blogs</a></li>
